...
pantalla = pygame.display.set_mode(RES, pygame.DOUBLEBUF | pygame.RESIZABLE) ## Resolución
font = pygame.font.Font("assets/din_medium.ttf", 17)

## Configuración del HUD/UI del radar
radar_template = pygame.image.load("assets/ui/ui_radar.png").convert_alpha()
radar_sweepbar = pygame.image.load("assets/ui/ui_radar_sweep_fs.png").convert_alpha()
swpbar_rect = radar_sweepbar.get_rect(center = (640, 360))

## Títulos
game_titles = {
"downed" : pygame.image.load("assets/titles/tl_aircraft_downed.png").convert_alpha(),
"landing_failed" : pygame.image.load("assets/titles/tl_landing_failed.png").convert_alpha(),
"success" : pygame.image.load("assets/titles/tl_mission_success.png").convert_alpha()}
...
class Aircraft(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('assets/ui/ui_radar_aircraft.png').convert_alpha()
...
class MissileObject(pygame.sprite.Sprite):
    ...
    def __init__(self, missile_id, yset):
        super().__init__()
        self.image = pygame.image.load('assets/ui/ui_missile.png').convert_alpha()
...
class RadarILS(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('assets/ui/ui_ils_signal.png').convert_alpha()
...
def missile_drop():
    ...
    while missile_active:
        ...
        if misil.rect.y > pygame.display.get_window_size()[1]:
            misil.kill()
...
fps_text = pygame.font.Font("assets/din_medium.ttf", 17)
...
while(1) == run:
    ...
    fps_text_2 = fps_text.render(f"FPS: {str(int(clock.get_fps()))}", True, "Green")
    pantalla.blit(fps_text_2, (5, 200))
